...
const RETRYABLE_PROVIDER_ERROR_PATTERN = buildProviderErrorPattern([
	...
	"too many requests",
	"429",
	// 400 is normally NOT retryable (malformed request), but some flaky
	// OpenAI-compatible gateways intermittently 400 valid requests (e.g. rejecting
	// a "developer" system role only sometimes). Retry to ride those out.
	"400",
	"500",
	"502",
	"503",
